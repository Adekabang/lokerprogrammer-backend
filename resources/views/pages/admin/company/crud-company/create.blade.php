                    ...
                    <div class="col-12">
                                ...
                                <form action="{{ route('company.store') }}" method="post">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" placeholder="Enter Company Name" class="form-control @error('company_name') is-invalid @enderror" name="company_name" value="{{ old('company_name') }}" required>
                                            @error('company_name')
                        ...
                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" placeholder="Enter Location" class="form-control @error('location') is-invalid @enderror" name="location" value="{{ old('location') }}" required>
                                            @error('location')
                                            <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" placeholder="Enter Contact" class="form-control @error('contact') is-invalid @enderror" name="contact" value="{{ old('contact') }}" required>
                                            @error('contact')
                                            <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Expired Date</label>
                                        <div class="col-sm-12 col-md-7">
                        ...
                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <select class="form-control custom-select selectric @error('package_id') is-invalid @enderror" name="package_id" required>
