                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <form id="delete-form-{{ $cat->id }}" class="d-inline" action="{{ route('category.destroy', $cat->id) }}" method="post">
                          @csrf
                          @method('delete')
...
@include('pages.admin.course.category.modals-category.edit')
@include('pages.admin.course.category.modals-category.create')
@endsection
