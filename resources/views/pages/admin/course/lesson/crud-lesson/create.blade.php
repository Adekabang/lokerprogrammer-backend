          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control @error('lesson_name') is-invalid @enderror" name="lesson_name" value="{{ old('lesson_name') }}" placeholder="Introduction to ..." required>
                  @error('lesson_name')
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control @error('episode') is-invalid @enderror" name="episode" value="{{ old('episode') }}" placeholder="Episode-1" required>
                  @error('episode')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" for="basic-url">Video Youtube URL</label>
                  <div class="input-group col-sm-12 col-md-7">
                    ...
                    <input type="text" class="form-control @error('video') is-invalid @enderror" id="basic-url" aria-describedby="basic-addon3" name="video" value="{{ old('video') }}" placeholder="Just the ID youtube video" required>
                    @error('video')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
