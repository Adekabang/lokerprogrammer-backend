        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header d-flex justify-content-between">
              ...
              <div>
                <a href="{{ route('coursePackageFeature.create') }}" class="modal-show btn btn-primary">Add Feature</a>
              </div>
            </div>
            <div class="card-body">
...
@push('addon-script')
    <script>
        $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('table.coursePackageFeature') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'id'},
                {data: 'course_package.package_name', name: 'course_package.package_name'},
